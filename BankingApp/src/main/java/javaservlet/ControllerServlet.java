...
public class ControllerServlet extends HttpServlet {
	...
	private void forwardController(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		case("addnewuser"):{
			...
			try {
				int id=admin.createNewUser(String.valueOf(request.getParameter("name")), 
						request.getParameter("email"), Long.parseLong(request.getParameter("dateofbirth")), Long.parseLong(request.getParameter("mobile")), request.getParameter("address"), userType);
			...
			RequestDispatcher dispatch=request.getRequestDispatcher("jsp/adduser.jsp");
			dispatch.forward(request, response);}
			break;
		}
		case("addaccount"):{
